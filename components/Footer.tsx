        ...
        <div className="center">
          <div className="community centered">
            <div className="center">
              ...
              <div className="social">
                ...
                <a
                  href="https://www.reddit.com/user/PoofyLand"
                  target="_blank"
                  className="reddit "
                  style={{ width: 58, height: 58 }}
                >
          ...
          <div className="partners" style={{ visibility: "visible" }}>
            ...
            <div className="centered">
              <img src="/imgs/ddc.png" data-aos="zoom-in" alt="" />
              <img src="/imgs/crossspace-2.png" data-aos="zoom-in" alt="" />
            </div>
          </div>
          ...
          <div className="partners" style={{ visibility: "visible" }}>
            ...
            <div className="centered">
              <a href="https://unity.com/" target="_blank">
                <img src="/imgs/unity.png" data-aos="zoom-in" alt="" />
              </a>
            </div>
          </div>
